...
Classes/CreateMap.cpp Classes/AddPlant.cpp Classes/ScrollBar.cpp

##Testing whether or not GLOBing .cpp files will work, commenting out above and implementing below.
OBJS = main.cpp Classes/*.cpp
CXX = g++
CPPFLAGS = -WALL
INCLUDES = -I /Classes
